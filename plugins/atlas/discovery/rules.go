...
var DefaultRules = []Rule{
	...
	{MatchFile: "pyproject.toml", Type: "app"},
	{MatchFile: "requirements.txt", Type: "app"},
	{MatchFile: "pom.xml", Type: "app"},
	{MatchFile: "build.gradle", Type: "app"},
	{MatchFile: "Cargo.toml", Type: "app"},
	{MatchGlob: "*.csproj", Type: "app"},
	{MatchFile: "Dockerfile", Type: "infra"},
	{MatchFile: "docker-compose.yml", Type: "infra"},
	{MatchFile: "docker-compose.yaml", Type: "infra"},
