...
var defaultHints = map[string]string{
	...
	ErrCodeCloudTokenExpired:  "Token cloud expirado. Execute 'yby cloud refresh' para renovar as credenciais.",
	ErrCodeCloudCLIMissing:    "CLI do cloud provider não encontrado. Instale o CLI correspondente (aws, az ou gcloud) e verifique o PATH.",
	ErrCodeCloudModelDisabled: "Modelo de IA desabilitado ou indisponível neste provider cloud. Verifique as cotas e permissões da sua conta.",
}
